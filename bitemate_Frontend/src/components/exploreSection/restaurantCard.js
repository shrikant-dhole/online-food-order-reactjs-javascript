...
const RestaurantCard = ({ restaurant }) => {
  ...
  return (
    <div className="restaurant-card curs-pointer">
      <div className="restaurant-card-cover">
        <img src={coverImg} alt={name} className="restaurant-card-image" />
      ...
      <div className="res-row">
        ...
        {rating && (
          <div className="res-rating absolute-center">
            {" "}
            {rating}{" "}
            <FontAwesomeIcon icon={faStar} className="absolute-center res-rating-icon" />{" "}
          </div>
        )}
      </div>
      <div className="res-row">
